...
-- alter table base_user_info add `id` bigint(20) NOT NULL;
-- update base_user_info set id = 1;
-- alter table base_user_info add `region` varchar(255) DEFAULT NULL;
-- update base_user_info set region = 'com';
